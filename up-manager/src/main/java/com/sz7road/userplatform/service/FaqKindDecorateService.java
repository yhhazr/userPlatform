 ...
 */
@Singleton
public class FaqKindDecorateService extends FaqKindService {
    @Inject
    private Provider<FaqKindDecorateDao> faqKindDaoProvider;

    private FaqKindDecorateDao getFaqKindDao() {
        FaqKindDecorateDao faqKindDecorateDao = faqKindDaoProvider.get();

        if (faqKindDecorateDao == null) {
            throw new NullPointerException("faqKindDao null");
        }
        return faqKindDecorateDao;
    }
