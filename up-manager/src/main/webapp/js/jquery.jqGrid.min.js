...
(function (c) {
    ...
    c.fmatter.util = {NumberFormat:function (a, b) {
        ...
        if (!isNaN(b - 0) && "u" == ("" + a).toLowerCase())i = new Date(parseFloat(b)); else if (b.constructor === Date)i = b; else if (null !== g)i = new Date(parseInt(g[1], 10)), g[3] && (a = 60 * Number(g[5]) + Number(g[6]), a *= "-" == g[4] ? 1 : -1, a -= i.getTimezoneOffset(), i.setTime(Number(Number(i) + 6E4 * a)));
        else {
            b = ("" + b).split(/[\\\/:_;.,\t\T\s-]/);
            a = a.split(/[\\\/:_;.,\t\T\s-]/);
            g = 0;
