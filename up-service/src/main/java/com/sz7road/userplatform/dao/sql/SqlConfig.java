...
public class SqlConfig {
    ...
    public static final String ORDER_COUNT = "" +
            ...
            "join conf_userplatform.conf_server_table as st on od.zoneId=st.id " +
    ...
    public static final String ORDER_SELECT = "" +
            ...
            "gt.gameName AS gameName,gt.goldName AS gameGoldName,st.serverName AS serverName,pt.channelName AS channelName," +
