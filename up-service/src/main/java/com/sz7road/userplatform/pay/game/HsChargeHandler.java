...
@RequestScoped
public class HsChargeHandler implements GameRechargeHandler{

    static final Logger log = LoggerFactory.getLogger(HsChargeHandler.class.getName());
