...
public class IPSeeker {
     ...
     * </pre>
     */
    public final static Logger logger = LoggerFactory.getLogger(IPSeeker.class);
...
//            ConfigurationUtils.get("ipdata.dir");//IP数据库文件的保存路径";
            "E:/work/运营平台/up-web/src/main/webapp/resource/qqwry.dat";
...
//            logger.error(IPSeeker.class.getResource(IP_FILE).toString());
//            logger.error(IP_FILE);
    ...
    public static void main(String args[]) {
        ...
        String ip = "38.25.63.10";
        String country = ipSeeker.getCountry(ip);
        String area = ipSeeker.getArea(ip);
//        List list=ipSeeker.getIPEntries("深圳");
        System.out.print(country + " , " + area + " ," + ipSeeker.getAddress(ip));
    }
}
