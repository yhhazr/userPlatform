...
//            BufferedInputStream ksbufin = new BufferedInputStream(ksfis);
            ...
            char[] keyPwd = "love7road".toCharArray();
            //char[] keyPwd = "YaoJiaNiLOVE999Year".toCharArray();
            ks.load(ksbufin, keyPwd);
            // 从密钥仓库得到私钥
            PrivateKey priK = (PrivateKey) ks.getKey("7road-alias", keyPwd);
    ...
    public  boolean enCodeByCer(String val, String msg) {
        ...
        try {
            //获得文件(相对路径)
//            String file = Pkipair.class.getResource("99bill[1].cert.rsa.20140728.cer").toURI().getPath();
