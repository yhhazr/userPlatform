...
public class ImageCut {
     ...
     */
    public static boolean abscut(String srcImageFile, String dirImageFile, int x, int y, int destWidth, int destHeight) {
        boolean flag=false;
        try {
            Image img;
            ...
            if (srcWidth >= destWidth && srcHeight >= destHeight) {
                ...
                g.dispose();
                // 输出为文件
               flag= ImageIO.write(tag, "JPEG", new File(dirImageFile));
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
