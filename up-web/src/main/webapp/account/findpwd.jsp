        ...
        <div id="payNet" class="getMain">
            ...
            <div class="getPwdBody">
                ...
                <div id="inputMsg" class="inputMsg">
                    ...
                    <form id="findPwdForm" name="findPwdForm" action="FindPwdWay" method="post">
                        <input type="hidden" id="verify" name="verify" value="">
                        <div class="getPwdMain" id="getPwd_item_1">
                            <div class="getContent">
                                <p>用户名：<input type="text" id="txt_user" name="userName" class="inpuText"/></p>

                                <p>验证码：<input type="text" id="txt_code" name="code" class="inpuText"/></p>

                                <p><img src="" alt="" id="verifyCodeImg" class="imgCode">
                                    <a class="codeText" href="javascript:void(0)" onclick="changeVerifyCode()">看不清，换一张</a>
                                </p>
    ...
    function doNext() {
        ...
        if (user.length < 1) {
            ...
            $.ajax({
                ...
                dataType:"JSON",
                url:"/CheckVerifyCode",
                data:{"userName":user, "verifyCode":verify, "code":code},
