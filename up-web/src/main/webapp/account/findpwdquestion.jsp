            ...
            <div class="getPwdBody">
                ...
                <div id="inputMsg" class="inputMsg">
                    <div id="tabs" class="tabs">
                        <ul class="ul_tabs">
                            <li id="item-1" class="tb-item">找回密码</li>
                        </ul>
                    </div>

                    <div class="getPwdMain" id="getPwd_item_1">
                        <div class="getContent">
                            <form id="questionForm" name="questionForm" method="post" action="FindPwdReset">
                                <input type="hidden" name="userName" value="${userName}">
                                <input type="hidden" name="code" value="${code}">
                                <input type="hidden" name="type" value="${type}">
                                <input type="hidden" name="verify" value="${verify}">
                                <input type="hidden" name="q1" value="${list[0].question}">
                                <input type="hidden" name="q2" value="${list[1].question}">
                                <input type="hidden" name="q3" value="${list[2].question}">

                                <p>密码问题一：<span id="span_q1">${list[0].question}</span></p>
                                <p>答案：<input type="text" id="txt_a1" name="a1" maxlength="30"></p>

                                <p>密码问题二：<span id="span_q2">${list[1].question}</span></p>
                                <p>答案：<input type="text" id="txt_a2" name="a2" maxlength="30"></p>

                                <p>密码问题三：<span id="span_q3">${list[2].question}</span></p>
                                <p>答案：<input type="text" id="txt_a3" name="a3" maxlength="30"></p>

                                <p style="margin:35px 0px;"><span class="btn_next" id="btn_next_sub">下一步</span></p>
                            </form>
                        </div>
                        <div class="tips" id="tips"><img src="${imageDomainUrl}/img/jg.gif" alt="">
