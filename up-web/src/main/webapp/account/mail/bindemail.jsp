...
<div class="rgtcontent">
    <h2 class="h2_title">邮箱绑定</h2>
    <div class="blank15"></div>
    <div class="emailbox emailbox_1">
        <div class="now_buzhou now_buzhou1"></div>
        <div class="entryemail relative left">
            <label class="f14px">输入邮箱：</label>
            <input type="text" class="textinput emailYz" maxlength="30" />
            ...
            <div class="formerr formerr_email" style="left:430px;">
    ...
    <div class="emailbox none emailbox_2">
        <div class="now_buzhou now_buzhou2"></div>
        <div class="blank15"></div>
        <div class="yz_email">
    ...
    <div class="emailbox none emailbox_3">
        <div class="now_buzhou now_buzhou3"></div>
        <div class="blank15"></div>
        <div class="yz_email">
            <div class="yz_emailbox">
                <div class="anquandun emaildun"></div>
                <div class="anquantishi">
                    <strong class="a">安全邮箱已设置，不用为密码丢失烦心了！</strong>
                    <strong class="c"><span class="one">已设置安全邮箱：</span><span class="two">@mail.com</span><span class="three"></span><cite class="blank"></cite></strong>
                    <div class="blank20"></div>
                    <div class="jiechuemail_ok">
                        <a href="/accountcenter.html" class="theprev left theprev_1">返回首页</a>
                        <!--<a href="javascript:void(0)" title="解除绑定" class="thenext left thenext_6" style="margin:0 0 0 30px;">解除绑定</a>-->
                    </div>
                </div>
                <div class="blank"></div>
            </div>
...
<script type="text/javascript">
    ...
    $(function(){
        ...
        $(".thenext_1").click(function(){
            ...
            email = $(".entryemail input").val();
            time = new Date().getTime();
            $(".emailbox_2 .b").html(email);
            $(".emailbox_3 .two").html(email);
        ...
        $(".thenext_2").click(function(){
            ...
            $.ajax({
                ...
                data:{userName:"", email:email, code:code, time:time, type:"bind"},
                async:false,
            ...
            $(".yanzhengma input:text").focus(function(){
                $(".yanzhengma .formerr").hide();
            });
        });
    ...
    function sendEmailCode(){
        ...
        $.ajax({
            ...
            data:{userName:"", email:email, time:time, type:"bind"},
            async:false,
            success:function (msg) {
                if (msg.code > 0) {
