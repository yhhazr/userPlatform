                    ...
                    <c:choose>
                        <c:when test="${isPass}">
                            <div id="userInputMsg" class="userInputMsg">
                                <input type="text" hidden="true" value="${un}" id="value_un">
                                <input type="text" hidden="true" value="${ut}" id="value_ut">
                                <input type="text" hidden="true" value="${_c}" id="value_code">

                                <p>用户名：<span style="padding-right:153px; font-weight:bold;" id="_uName">${_u}</span></p>

                                <p>新密码：<input type="password" id="txt_pwd1" class="inpuText"/></p>

                                <p>确认新密码：<input type="password" id="txt_pwd2" class="inpuText"/></p>

                                <p style="margin:35px 0px;"><span class="btn_next" style="margin-right:90px;"
                                                                  id="btn_update_sub">重置密码</span></p>
                            </div>
                        ...
                        <c:otherwise>
                            <div id="updateMsg" class="tips">找回密码的链接错误、已过期或者链接失效。
                                <p style="margin:35px 0px; text-align:center;"><span class="btn_next" id="btn_login_sub"
                                                                                     onclick="gotoGetBackPwd()"> 返回找回密码 </span>
                                </p>
                            </div>
                        </c:otherwise>
                    </c:choose>
...
<script type="text/javascript">
    ...
    function doUpdate() {
        var _un = $("#value_un").val();
        var _ut = $("#value_ut").val();
        var _c = $("#value_code").val();
        ...
        if (pwd.length < 1) {
            ...
            $.ajax({
                ...
                dataType:"JSON",
                url:"/ResetPwdSubmit",
                data:{un:_un, ut:_ut, _c:_c, pwd:pwd, r_pwd:r_pwd},
