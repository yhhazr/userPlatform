...
<div id="main">
    <div class="geren_content">
        <div class="cz_left" align="center">
            ...
            <div class="czyc" style="margin-top:50px;">
                ...
                <div class="err_msg">
                    ...
                    <div id="showResult">
                        <table width="70%" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                                ...
                                <td class="fnt_czyc" align="left">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span
                                        id="order_no">${requestScope.orderId}</span></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td class="fnt_czyc" align="left">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span
                                        id="game_amount">${requestScope.gold}${game.goldName}</span></td>
                            </tr>
                        </table>
                    </div>
                    ...
                    <div class="czyc_btn">
                        <a id="go2Game" href="${game.homePage}/serverList.html"><img
        ...
        <div class="cz_right">
            <div class="span2" style="width:160px;margin:0 0 0 8px;display:inline;">
