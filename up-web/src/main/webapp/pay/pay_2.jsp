...
<script type="text/javascript" charset="UTF-8" src="${staticDomainUrl}/scripts/pay_2.js"></script>
...
<div class="ym-col1">
    <div class="sidebar-nav">
        <ul id="payUl" class="nav nav-list">
            ...
            <!--              <li ><a href="#a2" id="aa2" onclick="changePayWay('aa2');" >财付通充值</a></li>
      <li ><a href="#a17" id="aa17" onclick="changePayWay('aa17');"  >人工汇款充值</a></li>-->
...
<script type="text/javascript">
    ...
    $(function(){
        ...
        if (serverParam && !isNaN(serverParam)) {
            $("#server_id").find("option[value='" + serverParam + "']").attr("selected", "selected");
