...
<script type="text/javascript" charset="UTF-8" src="${staticDomainUrl}/scripts/online_game.js"></script>
...
<div id="header" class="ym-wrapper"
     style="height:74px;background: url(${imageDomainUrl}/img/bg.jpg) repeat; box-shadow:0 0 ">
    <div class="ym-grid">
        <div class="ym-g20 ym-gl">
            <a href="#" title="logo"><img src="${imageDomainUrl}/img/logo.jpg" alt="7road" width="203"
                                          height="74"></a>
        </div>
        <div class="ym-g18 ym-gl">
            <img src="${imageDomainUrl}/img/kh.jpg" alt="7road" width="187" height="74">
        </div>
        <div class="ym-g10 ym-gl">
            <a href="${homePageUrl}" class="m1"></a>
        </div>
        <div class="ym-g13 ym-gl">
            <a href="${accountUrl}" class="m2"></a>
        </div>
        <div class="ym-g13 ym-gl">
            <a href="${payPageUrl}" class="m3"></a>
        </div>
        <%--
        <div class="ym-g13 ym-gl">
            <a href="${customerUrl}" class="m4"></a>
        </div>
        --%>
        <div class="ym-g13 ym-gl">
            <a href="http://account.7road.com/forget.html" class="m4"></a>
        </div>
        <div class="ym-g13 ym-gl">
            <a href="${forumUrl}" class="m5"></a>
        </div>
    </div>
</div>
...
<div class="ym-col1">
    <div class="sidebar-nav">
        <ul id="payUl" class="nav nav-list">
            ...
            <li class="active"><a href="#" id="aa1">网银充值</a></li>
    ...
    <div style="margin-top:1.5em;margin-left:20px;">
...
<!--              <div style="height:30px;line-height:30px; text-indent:12px; font-size:14px;font-weight:bold;">
              您当前选择的是“<span id="pay_way_CN" class="label label-important">网银充值</span>”的充值方式
              </div>-->
...
<!--                  <div id="hiddenPannel">
                        ...
                        <input type="hidden" name="p" value="" id="role">
                        <input type="hidden" name="amount" value="" id="amount">
                        <input type="hidden" name="_g" id="gameId" value="1">
                        <input type="hidden" name="_c" value="C" id="channel">
                        <input type="hidden" name="_s" value="3" id="s_id">
                        <input type="hidden" name="_n" value="" id="sign">
                        <input type="hidden" name="_f" value="" id="f_id">
...
<div class="ym-grid">
    ...
    <div class="ym-g25 ym-gl">
        <div class="ym-gbox ym-fbox-text">
            <img src="${imageDomainUrl}/img/tem_18.jpg" width="201" height="70" id="game">
        </div>
    </div>
...
<div class="ym-grid">
    ...
    <div class="ym-g30 ym-gl">
        <div class="ym-fbox-text">
            <input type="text" id="username" placeholder="请在此输入您的账号." onblur="userNameOnBlur()"
                   onfocus="userNameOnFocus()" value="" onkeyup="value=value.replace(/[^\w\.\/]/ig,'')"/>
        </div>
    </div>
    <div class="ym-g30 ym-gl" id="userNameTip">
        请输入您的七道账号
    </div>
</div>
<div class="ym-grid">
    <div class="ym-g15 ym-gl">
        <label for="username">确认帐号:</label>
    </div>
    <div class="ym-g30 ym-gl">
        <div class="ym-fbox-text">
            <input type="text" id="username_1" placeholder="请再次输入您的账号." onblur="userName1OnBlur()"
                   onfocus="userName1OnFocus()" onkeyup="value=value.replace(/[^\w\.\/]/ig,'')" value="">
        </div>
    </div>
    <div class="ym-g30 ym-gl" id="userName1Tip">
        请再次输入您的七道账号
    </div>
</div>
<div class="ym-grid">
    ...
    <div class="ym-g30 ym-gl">
        <div class="ym-fbox-select">
            <select id="actor_name" style="width:235px;">
...
<div class="ym-grid">
    ...
    <div class="ym-g30 ym-gl">
        <div id="selectPay" class="ym-fbox-select">
            <select id="selectMoney" onchange="moneyChange()">
        ...
        <div class="ym-fbox-text" id="custom_charge" style="display:none;">
            <input type="text" value="" id="money" onkeyup="checkMoney();"/>
        </div>
...
<div class="ym-grid">
    ...
    <div class="ym-g25 ym-gl" id="proportion">
        充值比例1:10
    </div>
</div>
    ...
    <div class="ym-g66 ym-gl">
        <div class="ym-grid">
            <div class="ym-g30 ym-gl" id="applay">
                <div class="ym-fbox-check">
                    <input type="radio" id="payA" name="pay" value="A" checked="checked"/>
                    <label onclick="checkedRaido('payA');">支付宝</label>
                </div>
            </div>

            <div class="ym-g30 ym-gl" id="quick">
                <div class="ym-fbox-check">
                    <input type="radio" id="payD" name="pay" value="D"/>
                    <label onclick="checkedRaido('payD');">快钱</label>
                </div>
            </div>

            <div class="ym-g38 ym-gl">
                <div class="ym-fbox-check" id="yibao">
                    <input type="radio" name="pay" id="payC" value="C"/>
                    <label onclick="checkedRaido('payC');">易宝支付</label>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="ym-g60 ym-gl">
        <div class="ym-grid">
            <div class="ym-g50 ym-gl">
                <div class="ym-fbox-check">
                    <input type="radio" id="ZHENGTU" name="card" checked="checked" value="D">
                    <label onclick="checkedRaido('ZHENGTU');">征途游戏卡</label>
                </div>
            </div>
            <div class="ym-g50 ym-gl">
                <div class="ym-fbox-check">
                    <input type="radio" id="U" name="card" value="U">
                    <label onclick="checkedRaido('U');">完美一卡通</label>
                </div>
            </div>
        </div>
        ...
        <div class="ym-grid">
            <div class="ym-g50 ym-gl">
                <div class="ym-fbox-check">
                    <input type="radio" id="M" name="card" value="M">
                    <label onclick="checkedRaido('M');">网易一卡通</label>
                </div>
            </div>
            <div class="ym-g50 ym-gl">
                <div class="ym-fbox-check">
                    <input type="radio" id="TIANXIA-NET" name="card" value="TIANXIA-NET">
                    <label onclick="checkedRaido('TIANXIA-NET');">天下一卡通</label>
                </div>
            </div>
        </div>
        ...
        <div class="ym-grid">
            <div class="ym-g50 ym-gl">
                <div class="ym-fbox-check">
                    <input type="radio" id="ZONGYOU-NET" name="card" value="ZONGYOU-NET">
                    <label onclick="checkedRaido('ZONGYOU-NET');">纵游游戏卡</label>
                </div>
            </div>
            <div class="ym-g50 ym-gl">
                <div class="ym-fbox-check">
                    <input type="radio" id="TIANHONG-NET" name="card" value="TIANHONG-NET">
                    <label onclick="checkedRaido('TIANHONG-NET');">天宏一卡通</label>
                </div>
            </div>
        </div>
    </div>
...
<div class="descripe" id="unionpay">
    ...
    <ol>
        ...
        <li>请使用IE，TT，Maxthon浏览器以确保易宝充值成功</li>
...
<div id="mannualpay" style="display:none;">
    ...
    3、银行汇款或转帐的实到金额享有和网银充值相同的充值比例，异地和跨行汇款或转帐的手续费根据各银行规定由银行向用户收取。<br>
...
<div id="footer">
    <div class="float-right">
        <img src="${imageDomainUrl}/img/index_bom_pic1.jpg"> <img src="${imageDomainUrl}/img/index_bom_pic2.jpg">
        <img src="${imageDomainUrl}/img/index_bom_pic3.jpg">
    </div>
    <div><a href="http://pay.7road.com/?gameid=1&type=game#">第七大道</a> &nbsp;|&nbsp; <a
            href="http://pay.7road.com/?gameid=1&type=game#">合作伙伴&nbsp;|&nbsp; </a><a
            href="http://pay.7road.com/?gameid=1&type=game#">招贤纳士</a>
        &nbsp;| &nbsp; <a href="http://pay.7road.com/?gameid=1&type=game#">成员福利</a> &nbsp;| &nbsp; <a
                href="http://pay.7road.com/?gameid=1&type=game#">联系方式</a> &nbsp; | &nbsp; <a
                href="http://pay.7road.com/?gameid=1&type=game#">意见反馈&nbsp;
            | &nbsp; </a><a href="http://pay.7road.com/?gameid=1&type=game#">法律声明</a> &nbsp; | &nbsp; <a
                href="http://pay.7road.com/?gameid=1&type=game#">父母须知</a></div>
    <div>公司地址：深圳市南山区深南大道9996号松日鼎盛大厦7-9层</div>
    <div>文网文[2010]207号 | 增值电信业务经营许可证：<a href="http://pay.7road.com/?gameid=1&type=game#">粤B2-20100091</a> | Copyright©
        2009 <a href="http://www.7road.com/">www.7road.com</a> All rights reserved.
    </div>
...
<div class="czqr" id="showCon" style="display: none;min-width:0px;">
    ...
    <div class="qr-contant">
        <ul>
            <li>您充值的方式&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span id="pay_card_id">银行卡（快钱）充值</span>
            </li>
            <li>您充值的游戏&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span id="char_game_id">神曲</span>
            </li>
