...
function uploadSuccess(file, serverData) {
	try {
        ...
        progress.toggleCancel(false);
        var msg = $.parseJSON(serverData);
        $("#idCardImgPath").val(msg.object);
	} catch (ex) {
		this.debug(ex);
	}
}
...
$(function(){
    var settings = {
        ...
        upload_url: "uploadImgFile",
        post_params: {"user" : $("#userName").val()},
        ...
        button_width: "160",
        button_height: "22",
        button_placeholder_id: "spanBtnSelect",
        button_text: '<span class="theFont">选择文件</span>',
        button_text_style: ".theFont { font-size: 12; }",
        button_text_left_padding: 60,
